...
namespace Tbasic.Libraries
{
    internal class StringLib : Library
    {
        ...
        private void CharsToString(Parameters stackFrame)
        {
        ...
        private void StringLastIndexOf(Parameters stackFrame)
        {
            if (stackFrame.Count == 3) {
                stackFrame.Add(0);
            }
